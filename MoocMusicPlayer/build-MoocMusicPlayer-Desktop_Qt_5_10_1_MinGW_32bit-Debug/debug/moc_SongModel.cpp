...
#include "../../MoocMusicPlayer/SongModel.h"
...
QT_MOC_LITERAL(1, 10, 17), // "musicsPathChanged"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 10), // "musicsPath"
QT_MOC_LITERAL(4, 40, 14), // "addSongFromQML"
QT_MOC_LITERAL(5, 55, 8), // "fullPath"
QT_MOC_LITERAL(6, 64, 8) // "isFolder"

    },
    "SongModel\0musicsPathChanged\0\0musicsPath\0"
    "addSongFromQML\0fullPath\0isFolder"
};
...
void SongModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->musicsPathChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->addSongFromQML((*reinterpret_cast< const QUrl(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (SongModel::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SongModel::musicsPathChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SongModel::musicsPathChanged(QString _t1)
{
